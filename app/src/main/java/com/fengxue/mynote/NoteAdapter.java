...
class NoteAdapter extends BaseAdapter {
    ...
    private List<DataItem> mList;//对象list
    private Context itemcontext;//窗口对象
    public NoteAdapter(Context context,List<DataItem> list) {
        mList=list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        DataItem bean =mList.get(position);
        ...
        if(gettag==null){//titleview无tag
            ...
            }else {viewHolder.getContent().setText(bean.getContents().trim());}//传入文字
